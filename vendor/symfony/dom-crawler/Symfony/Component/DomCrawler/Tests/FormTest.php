...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetValues()
    {
        ...
        $this->assertEquals(array('bar' => 'bar'), $form->getValues(), '->getValues() does not includes not-checked checkboxes');

        $form = $this->createForm('<form><input type="file" name="foo" value="foo" /><input type="text" name="bar" value="bar" /><input type="submit" /></form>');
        $this->assertEquals(array('bar' => 'bar'), $form->getValues(), '->getValues() does not includes file input fields');
        ...
        $this->assertEquals(array('bar' => 'bar'), $form->getValues(), '->getValues() does not includes disabled fields');
    }
    ...
    public function testGetFiles()
    {
        ...
        $this->assertEquals(array(), $form->getFiles(), '->getFiles() does not includes disabled file fields');
    }
