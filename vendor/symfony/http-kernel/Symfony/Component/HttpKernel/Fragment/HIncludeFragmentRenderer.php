...
class HIncludeFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     *  * id:         An optional hx:includes tag id attribute
     *  * attributes: An optional array of hx:includes tag attributes
     */
    public function render($uri, Request $request, array $options = array())
    {
        ...
        return new Response(sprintf('<hx:includes src="%s"%s>%s</hx:includes>', $uri, $renderedAttributes, $content));
    }
